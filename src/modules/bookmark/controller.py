...
from src.modules.post.schema import PostOut, PostSummaryOut
from src.modules.user import service as user_service

router = APIRouter(prefix="/bookmarks", tags=["bookmarks"])

@router.post("/{post_id}", response_model=Dict[str, bool])
async def toggle_bookmark(
    ...
    return bookmark_service.toggle_bookmark(db, user.id, post_id)
...
async def get_user_bookmarks(
    ...
    # Return the post objects of these bookmarks
