...
- [service.py](file:///Users/wisapat/Documents/Code/Git/okard-backend/src/modules/home/service.py): ตรรกะทางธุรกิจสำหรับการเลือกแคมเปญที่ "มียอดสนับสนุนสูงสุด" และการคำนวณสถิติหมวดหมู่
...
graph TD
    ...
    HomeAPI -->|ดึงข้อมูลแนะนำ| CampRepo[Campaign Repository]
...
| :--- | :--- | :--- | :--- |
| `get_top_pledged_campaigns` | คัดเลือกโครงการที่ได้รับเงินสมทบมากที่สุด โดยสามารถเลือกกรองตามหมวดหมู่ได้ | `db`, `limit`, `category` | `List[Campaign]` |
...
3.  **การพึ่งพาข้ามโมดูล**: แม้ว่าจะไม่มีตารางเป็นของตนเอง แต่โมดูลหน้าแรกพึ่งพาโครงสร้างข้อมูล (Schemas) จากโมดูล `Campaign` และ `Payment` เป็นอย่างมาก
