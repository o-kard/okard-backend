...
1.  **การรายงานแบบ Polymorphic**: แม้ว่าปัจจุบันจะใช้สำหรับโพสต์ แต่โครงสร้างฐานข้อมูลอนุญาตให้ `reported_item_id` อ้างถึงเอนทิตีอื่นๆ ได้ผ่านพารามิเตอร์ `target_type` หากมีการขยายระบบในอนาคต
