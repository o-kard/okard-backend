...
โมดูลคำขอแก้ไขข้อมูลใช้กระบวนการธรรมาภิบาลแบบพิเศษสำหรับการแก้ไขโพสต์ที่เผยแพร่แล้ว เพื่อให้แน่ใจว่าการเปลี่ยนแปลงที่สำคัญ (เช่น ยอดเป้าหมายหรือของรางวัล) ได้รับการอนุมัติจากผู้สนับสนุนรายใหญ่
...
sequenceDiagram
    ...
    participant Post as โมดูลโพสต์
    ...
    alt เสียงส่วนใหญ่เห็นชอบ (>50%)
        Svc->>Post: นำการเปลี่ยนแปลงไปใช้โดยอัตโนมัติ
...
| `_generate_display_changes`| ยูทิลิตี้ภายในเพื่อสร้างรายการสรุปการเปลี่ยนแปลงที่มนุษย์อ่านเข้าใจได้ง่าย | `post`, `proposed_changes` | สตริง (Markdown) |

---

## 4. การสื่อสารและพารามิเตอร์ (Communication & Parameters)

1.  **ผู้สนับสนุน 11 อันดับแรก**: ระบบจะคัดเลือกผู้ใช้ 11 รายที่มียอดเงินสนับสนุนรวมสูงสุดในโพสต์นั้นๆ ให้ทำหน้าที่เป็น "ผู้อนุมัติ" (Approvers) โดยอัตโนมัติ
